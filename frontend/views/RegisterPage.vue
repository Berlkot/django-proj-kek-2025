      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
        <div class="rounded-md shadow-sm">
          ...
          <div class="mb-3">
            ...
            <input id="reg-phone_number" v-model="formData.phone_number" name="phone_number" type="tel"
              autocomplete="tel"
              class="appearance-none rounded-md relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
              placeholder="Номер телефона (необязательно)">
            <p v-if="formErrors.phone_number" class="text-red-500 text-xs mt-1">{{ formErrors.phone_number.join(', ') }}
            </p>
          </div>
          <div class="mb-3">
            ...
            <p v-if="formErrors.display_name" class="text-red-500 text-xs mt-1">{{ formErrors.display_name.join(', ') }}
            </p>
          </div>
          <div class="mb-3">
          ...
          <div>
            ...
            <p v-if="formErrors.re_password" class="text-red-500 text-xs mt-1">{{ formErrors.re_password.join(', ') }}
            </p>
          </div>
        </div>
