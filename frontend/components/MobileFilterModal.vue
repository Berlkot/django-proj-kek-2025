        ...
        <div v-if="isOpen"
          ...
          <div class="p-4 flex-grow overflow-y-auto">
            <form @submit.prevent="applyAndClose">
              ...
              <div class="mb-4">
                <label for="modal-filter-region"
                  class="block text-sm font-medium text-gray-700 mb-1">Город/Область</label>

                <select v-if="options.regions && options.regions.length > 0" id="modal-filter-region"
              ...
              <div class="mb-4">
                ...
                <select v-if="options.age_categories && options.age_categories.length > 0" id="modal-filter-age"
              ...
              <div class="mb-4">
                <label for="modal-filter-ad-type" class="block text-sm font-medium text-gray-700 mb-1">Тип
                  объявления</label>
                <select v-if="options.ad_statuses && options.ad_statuses.length > 0" id="modal-filter-ad-type"
                  ...
                  <option v-for="status in options.ad_statuses" :key="status.id" :value="status.id">{{ status.name }}
                  </option>
                </select>
                <div v-else class="w-full p-2.5 border border-gray-300 rounded-md bg-gray-100 text-gray-500 text-sm">
              ...
              <div class="mb-4">
                <label for="modal-filter-species" class="block text-sm font-medium text-gray-700 mb-1">Вид
                  животного</label>
                <select v-if="options.species && options.species.length > 0" id="modal-filter-species"
                  ...
                  <option v-for="specie in options.species" :key="specie.id" :value="specie.id">{{ specie.name }}
                  </option>
                </select>
                <div v-else class="w-full p-2.5 border border-gray-300 rounded-md bg-gray-100 text-gray-500 text-sm">
              ...
              <div class="mb-4">
                ...
                <select v-if="options.colors" id="modal-filter-color"
              ...
              <div class="mb-4">
                <label for="modal-filter-gender" class="block text-sm font-medium text-gray-700 mb-1">Пол
                  питомца</label>
                <select v-if="options.genders" id="modal-filter-gender"
