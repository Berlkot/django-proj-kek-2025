<template>
  ...
  <router-link :to="articleLink"
    ...
    <div class="p-4 md:p-5 flex flex-col" :class="{ 'flex-grow': large }">

      <h3 class="font-semibold text-gray-800 group-hover:text-green-600 transition-colors line-clamp-2" :class="[
      ...
      <p class="text-gray-600 mb-3 line-clamp-3" :class="[
